...
<div class="wrap-collapsible" markdown="1"><input id="overdriveCode" class="toggle" type="checkbox"><label for="overdriveCode" class="lbl-toggle">Click to show code</label>
...
<div class="wrap-collapsible" markdown="1"><input id="catalystCode" class="toggle" type="checkbox"><label for="catalystCode" class="lbl-toggle">Click to show code</label>
<div class="collapsible-content" markdown="1">
...
<div class="wrap-collapsible" markdown="1"><input id="littleHawkCode" class="toggle" type="checkbox"><label for="littleHawkCode" class="lbl-toggle">Click to show code</label>
<div class="collapsible-content" markdown="1">
