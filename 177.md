...
<div class="wrap-collapsible" markdown="1"> <input id="overdriveCode" class="toggle" type="checkbox"> <label for="overdriveCode" class="lbl-toggle">Click to show code</label> <div class="collapsible-content" markdown="1">
```c
...
And [this code](./Overdrive_Arm_Control_Includes2.h) (written partially by a team mentor) uses a PI controller to position the arm predictably.
...
<div class="wrap-collapsible" markdown="1"> <input id="catalystCode" class="toggle" type="checkbox"> <label for="catalystCode" class="lbl-toggle">Click to show code</label> <div class="collapsible-content" markdown="1">
```c
task usercontrol()
{
	//Zero encoder values
...
<div class="wrap-collapsible" markdown="1"> <input id="littleHawkCode" class="toggle" type="checkbox"> <label for="littleHawkCode" class="lbl-toggle">Click to show code</label> <div class="collapsible-content" markdown="1">
```c
task autonomous()
{
	switch(acase)
...
<iframe width="640" height="360" frameborder="0" src="https://mega.nz/embed/oMZEgLpb#psn2-b7iPP-FZ6H4uZIZVbbKCfutmn7aa0YT1on0zcU" allowfullscreen ></iframe> 
